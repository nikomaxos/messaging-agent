              ...
              <tbody>
                {items.map((m: any) => (
                  <tr key={m.id} className="border-b border-white/[0.03] hover:bg-white/[0.02]">
                    <td className="px-4 py-2 text-slate-600 dark:text-slate-400 font-mono text-xs">#{m.originalMessageId}</td>
                    <td className="px-4 py-2 text-slate-900 dark:text-white text-xs">
