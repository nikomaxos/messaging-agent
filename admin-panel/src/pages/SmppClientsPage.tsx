  ...
  return (
    <div className="p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">SMPP Clients</h1>
                ...
                <tr key={c.id} className="hover:bg-white/[0.02] transition">
                    ...
                    <>
                      ...
                      <td className="px-5 py-3">
                        {c.priority === 1 
                          ...
                          : <span className="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium bg-slate-500/10 text-slate-600 dark:text-slate-400 border border-slate-500/20">Marketing (P2)</span>}
                      </td>
                    </>
                  )}
                  <td className="px-5 py-3 text-xs text-slate-600 dark:text-slate-400">
                    {c.activeSessions && c.activeSessions.length > 0 ? (
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium bg-slate-500/10 text-slate-600 dark:text-slate-400 border border-slate-500/20">Offline</span>
                    )}
                  </td>
                      ...
                      {isEd ? (
                        ...
                        <>
                          {(c.activeSessions && c.activeSessions.length > 0) ? (
                            ...
                            })} className="flex items-center gap-1.5 px-2 py-1.5 text-xs font-medium text-orange-400 hover:text-slate-900 dark:text-white hover:bg-orange-500 focus:ring-2 focus:outline-none focus:ring-orange-300 rounded transition" title="Disconnect All Active Binds">
                              <Unplug size={14} /> Kick
                            </button>
                          ) : (
                          ...
                          <button onClick={() => startEdit(c)} className="p-1.5 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-200/50 dark:bg-white/5 rounded transition" title="Edit"><Pencil size={15} /></button>
                          <button onClick={() => setConfirmAction({
                            title: 'Delete Client',
