        ...
        <div className="bg-slate-100 dark:bg-[#1a1a2e] border border-slate-300 dark:border-white/10 rounded-xl p-6 max-w-2xl">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Protocol</label>
              ...
              <div>
                <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Sender ID</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Data Coding</label>
            ...
            <div>
              <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Destination Number</label>
            ...
            <div>
              <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Force Supplier Connection (Optional)</label>
            ...
            <div>
              <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Message Body</label>
              ...
              <div className="text-xs text-slate-700 dark:text-slate-500 mt-1 flex justify-end">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[700px]">
          <div className="bg-slate-100 dark:bg-[#1a1a2e] border border-slate-300 dark:border-white/10 rounded-xl p-6 overflow-y-auto">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Client Emulation</label>
              ...
              <div>
                <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Supplier Connection (Optional)</label>
          ...
          <div className="bg-white dark:bg-[#0a0a0f] border border-slate-300 dark:border-white/10 rounded-xl overflow-hidden flex flex-col shadow-2xl">
            <div className="p-3 bg-white/[0.02] border-b border-slate-200 dark:border-white/[0.05] flex items-center gap-2">
              <Activity size={16} className="text-slate-700 dark:text-slate-500" />
              <span className="text-sm font-mono text-slate-700 dark:text-slate-300">routing_trace.out</span>
            </div>
            <div className="p-4 overflow-y-auto font-mono text-sm flex-1 text-slate-700 dark:text-slate-300 space-y-2">
              {!emuResult ? (
                ...
                <>
                  ...
                  <div className="mt-6 border-t border-slate-300 dark:border-white/10 pt-4">
                    ...
                    <pre className="text-xs bg-slate-100 dark:bg-black/40 p-3 rounded overflow-x-auto text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-white/5">
                      {JSON.stringify({
      ...
      {activeTab === 'stress' && (
        <div className="bg-slate-100 dark:bg-[#1a1a2e] border border-slate-300 dark:border-white/10 rounded-xl p-6 max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Send Towards</label>
            ...
            {stressForm.sendTowards === 'SPECIFIC' && (
              <div>
                <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Specific Numbers (comma separated, international format)</label>
            ...
            {stressForm.sendTowards === 'RANDOM' && (
              <div className="bg-slate-100 dark:bg-black/20 p-4 border border-slate-300 dark:border-white/5 rounded-lg space-y-4">
                <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2 border-b border-slate-300 dark:border-white/5 pb-2">Generate Test Numbers</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1 flex items-center gap-1"><Globe size={14}/> Destination Country</label>
                  ...
                  <div>
                    <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Test Volume</label>
            ...
            <div className="bg-slate-100 dark:bg-black/20 p-4 border border-slate-300 dark:border-white/5 rounded-lg space-y-4">
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1 flex items-center gap-1"><Server size={14}/> Supplier Connection</label>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-300 dark:border-white/5">
                <div>
                  <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Simulation Mode</label>
                ...
                {stressForm.simulationMode === 'SIMULATE_DELIVERY' && (
                  <div>
                    <label className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Simulated Final Status</label>
