      ...
      <div className="glass w-full max-w-lg rounded-xl shadow-2xl border border-brand-500/50 flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between p-4 border-b border-brand-500/20 bg-brand-500/10 rounded-t-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white leading-tight">Matrix Setup Guide</h3>
              <p className="text-xs text-brand-200">Pairing Device: {device.name}</p>
            </div>
          </div>
          <button onClick={onClose} className="p-1.5 hover:bg-slate-200 dark:bg-white/10 rounded-lg transition text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white">
            <X size={20} />
          </button>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-1">Open the self-hosted Matrix client in a new tab.</p>
