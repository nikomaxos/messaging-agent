package com.messagingagent.ai.controller;
...
import com.messagingagent.ai.service.AiChatService;
import com.messagingagent.ai.service.AiMemoryService;
...
public class AiAgentController {
    ...
    public Map<String, Object> getAgentContext() {
        try {
            ...
            Map<String, Object> health = restTemplate.getForObject(coreServiceUrl + "/api/system/health", Map.class);
            return health;
        } catch (Exception e) {
            log.error("Failed to fetch context from core-service: {}", e.getMessage());
            return Map.of("error", "Failed to fetch system context");
        }
    }
